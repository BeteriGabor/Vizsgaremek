    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        if (response.status === 200) {
          ...
          alert("Something went wrong during withdraw! Try again later!" , error);
          console.error(error);
      }
    }
              ...
              <Box sx={style} >
                <h2 className="text-xl">Withdraw your money!</h2>
                  <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="bg-green-500 text-white px-4 py-2 rounded" onClick={handleSubmit}>Withdraw</button>
